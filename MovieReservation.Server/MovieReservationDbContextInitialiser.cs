    ...
    public class MovieReservationDbContextInitialiser
    {
        ...
        public async Task TrySeedAsync()
        {
            ...
            if (!_userManager.Users.Any())
            {
                var users = new[]
                {
                    new { Email = "proladinh144@gmail.com", Password = "Admin@123", Address = "Karachi", Contact = "+923009999999", Role = "Admin" },
                    new { Email = "dinhknd3@gmail.com", Password = "User@123", Address = "Karachi", Contact = "+923009999999", Role = "ApiUser" },
                    new { Email = "arafaysaleem@gmail.com", Password = "User@123", Address = "Karachi", Contact = "+923009999999", Role = "ApiUser" },
                    new { Email = "user2@gmail.com", Password = "User@123", Address = "Karachi", Contact = "+923009999999", Role = "ApiUser" },
                    new { Email = "user3@gmail.com", Password = "User@123", Address = "Karachi", Contact = "+923009999999", Role = "ApiUser" },
                    new { Email = "deleteme@eztickets.com", Password = "User@123", Address = "Re", Contact = "+923009268622", Role = "ApiUser" },
                    new { Email = "user4@gmail.com", Password = "User@123", Address = "Lahore", Contact = "+923001234567", Role = "ApiUser" },
                    new { Email = "user5@gmail.com", Password = "User@123", Address = "Islamabad", Contact = "+923008765432", Role = "ApiUser" },
                    new { Email = "user6@gmail.com", Password = "User@123", Address = "Peshawar", Contact = "+923007654321", Role = "ApiUser" },
                    new { Email = "user7@gmail.com", Password = "User@123", Address = "Quetta", Contact = "+923006543210", Role = "ApiUser" }
                };
